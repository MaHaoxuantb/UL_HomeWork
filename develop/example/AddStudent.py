...
def add_student(student_id, name, email, class_ids, age, gender, phone_number, key):
...
student_id = '123'  # Unique student ID (primary key)
password = '123'  # An additional key attribute, can be anything you choose
...
# Add the student
add_student(student_id, name, email, class_ids, age, gender, phone_number, key)
